...
\section{ผลการทดสอบด้วยการจับ Element บนหน้าจอโดยไม่ต้องแก้ไขที่ Source Code}
    ...
    \subsection{หน้า Log-in : กรอกรหัสพนักงาน และ รหัสผ่าน ถูกต้อง}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.35\textwidth]{loginPass1}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.35\textwidth]{logout1}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.35\textwidth]{stock1}
    ...
    %     \caption{ข้อดีและข้อเสีย}\label{posAndNeg} \\
    %     \hline
    %     \multicolumn{1}{|c|}{\textbf{ข้อดี}}	&	\multicolumn{1}{c|}{\textbf{ข้อเสีย}} \\
    %     \hline
    %     \endfirsthead
    %     \caption* {\textbf{ตารางที่ \ref{posAndNeg} (ต่อ)} ข้อดีและข้อเสีย} \\
    %     \hline
    %     \multicolumn{1}{|c|}{\textbf{ข้อดี}}	&	\multicolumn{1}{c|}{\textbf{ข้อเสีย}} \\
    %     \hline
    %     \endhead
    %     \hline
    %     \endfoot
    %     ไม่ต้องแก้ที่ Source Code & ต้องทำแบบทดสอบ 2\\
    %     รวดเร็วในการทำการทดสอบ & ลำดับของ element มีโอกาสที่จะเปลี่ยน\\
    %     สามารถแสดงคียบอร์ดเปรียบเสมือการพิมพ์ได้ & \\
    %     \hline
    % \end{tabularx}
